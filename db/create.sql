...
--Tabel voor auteur (van review)
CREATE TABLE auteur (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
 name VARCHAR(255)
);

--Tabel voor producten wat kleding is
...
--Tabel voor producten wat voorwerpen zijn
...
--informatie voor tabel producten
